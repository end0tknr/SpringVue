...
public interface NewBuildRepository {
    ...
    @Select("SELECT * FROM newbuild_sales_count_by_shop WHERE pref='${prefName}' LIMIT 100")
    ...
    @Select("SELECT * FROM newbuild_sales_count_by_city WHERE pref='${prefName}' LIMIT 100")
   ...
   @Select(" SELECT tbl1.* FROM newbuild_sales_count_by_city tbl1 "+
		   ...
		   " WHERE tbl2.pref='${prefName}' AND tbl2.city='${cityName}' LIMIT 100 ")
