...
data_name = "住居の種類・住宅の所有の関係（6区分）別一般世帯数，"+ \
    "一般世帯人員及び1世帯当たり人員 －町丁・字等"
...
class Kokusei2015PopulationH07Service(
    ...
    def download_save_data_src(self,pref_url):
        ...
        util_db = Db()
        util_db.bulk_upsert("kokusei2015_population_h07",
                            pkey_cols,
